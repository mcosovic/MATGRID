 function [user] = measurement_variance_options(var, user)

%--------------------------------------------------------------------------
% Checks input measurement variances.
%
% The function checks 'legUnique', 'legRandom', 'legType', 'pmuUnique',
% 'pmuRandom', and 'pmuType', given as input arguments of the function
% leeloo in the 'power_estimation.m'. If variables are missing or are not
