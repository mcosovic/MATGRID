...
There are three basic modules:
   ...
   - **state estimation with built-in measurments generator** - using the executive m-file *power_estimation* runs the AC power flow, generates a set of measurements and continues with the state estimation;
