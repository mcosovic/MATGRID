...
%----------------------Info DC State Estimation Data-----------------------
 ...
 q0  =  '   |---------------------------------------------------------------------------------------------------------------|';
 q1  =  '   | Variable: result.observe.island and result.observe.branch (observability analysis routine)                    |';
 q2  =  '   |----------------------|----------------------------------------------------------------------------------------|';
 ...
 q8  =  '   |           1          |  from bus end                                                                          |';
 q9  =  '   |           2          |  to bus end                                                                            |';
 q10 =  '   |           3          |  indicator: observable branch (1); unobservable branch (0)                             |';
 q11 =  '   |           4          |  indicator: relevant branch (1); irrelevant branch (0)                                 |';
 q12 =  '   |----------------------|----------------------------------------------------------------------------------------|';
